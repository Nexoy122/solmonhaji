            ...
            return (
              <div key={i} className="border-2 border-black bg-white shadow-[4px_4px_0px_0px_#121212] md:border-4">
                <button
                  ...
                  className={`flex w-full items-center justify-between gap-4 px-5 py-4 text-left transition-colors duration-200 ${isOpen ? "bg-[#FF0033] text-white" : "bg-white text-black hover:bg-[#F0F0F0]"}`}
                >
