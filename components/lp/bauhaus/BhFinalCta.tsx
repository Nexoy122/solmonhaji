...
export function BhFinalCta() {
  return (
    <section className="relative overflow-hidden border-b-4 border-black bg-[#F0C020]">
      ...
      <span className="pointer-events-none absolute -bottom-20 -right-16 h-72 w-72 rotate-45 border-4 border-black bg-[#FF0033] opacity-50" />

      <div className="relative mx-auto max-w-4xl px-4 py-20 text-center md:px-8 md:py-28">
        {/* oversized play button */}
        <span className="mx-auto mb-7 flex h-16 w-24 items-center justify-center rounded-[12px] border-4 border-black bg-[#FF0033] shadow-[6px_6px_0_0_#121212]">
          <span className="bh-play ml-1 h-7 w-6 bg-white" />
        </span>
        ...
        <p className="mx-auto mt-6 max-w-lg text-[18px] font-medium text-black/80">
          Find the Shorts that are actually working in your niche, and turn them into your next upload.
        </p>
        <div className="mt-10 flex justify-center">
          <BhButton href="/signup" color="red" className="!px-8 !py-4 !text-[16px]">
            Get 100 free credits <ArrowRight className="h-5 w-5" strokeWidth={3} />
          </BhButton>
        </div>
      </div>
    </section>
