...
const AV = ["#D02020", "#1040C0", "#F0C020"];

export function BhReviews() {
  return (
    <section id="reviews" className="border-b-4 border-black bg-[#D02020] bh-dots-light">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {REVIEWS.map((r, i) => (
            <div key={r.handle} className="flex flex-col border-2 border-black bg-white p-6 shadow-[6px_6px_0px_0px_#121212] md:border-4">
              <Quote className="h-8 w-8 text-[#D02020]" strokeWidth={2.5} fill="currentColor" />
